...
use crate::timeline::time_ranges_ui::TimeRangesUi;
...
pub fn paint_time_ranges_and_ticks(
    ...
    // eprintln!("there are {} segments", time_ranges_ui.segments.len());
...
pub fn paint_time_ranges_and_ticks_range(
    // time_ranges_ui: &TimeRangesUi,
...
pub fn format_int(number: i64) -> String
where
{
    if number < 0 {
...
where
    Uint: std::fmt::Display + num_traits::Unsigned,
{
    add_thousands_separators(&number.to_string())
}
